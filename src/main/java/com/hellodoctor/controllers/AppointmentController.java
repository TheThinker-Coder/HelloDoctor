...
import com.hellodoctor.servicesimplements.FileStorageServiceImpl;
...
public class AppointmentController {
	...
	@Autowired FileStorageServiceImpl fileStorageServiceImpl;
	...
	public AppointmentResponceDto saveAppointment(@ModelAttribute AppointmentRequestDto appointmentRequestDto, MultipartFile file) {
		String fileAttech = fileStorageServiceImpl.storeFile(file);
